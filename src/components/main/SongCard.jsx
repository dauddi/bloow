...
const SongCard = ({ song, activeSongInQueue, playSong, pauseSong }) => {
  ...
  return (
    <figure className="relative flex flex-col min-w-[180px] min-h-[180px] ml-2 md:w-[15%] md:m-4 hover:scale-105 transition-all " > 
